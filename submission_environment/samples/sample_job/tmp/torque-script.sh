...
java -jar "/home/user/hunziker/katts/submission_environment/scripts/evaluation.jar" --google-username "katts.evaluation@gmail.com" --google-password "kattsevaluationongdocs" --google-spreadsheet-name "sample_experiment" --job-name "sample" "$EVALUATION_FOLDER"
