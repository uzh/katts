...
/**
 * This class helps to map between Xml types and java
 * class types. 
 * 
...
public final class XmlTypeMapping {
	...
	public final static <T> T converFromString(String input, Class<?> type) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		
//		Method method;
//		try {
//			if ((method = type.getDeclaredMethod("valueOf", String.class)) != null) {
