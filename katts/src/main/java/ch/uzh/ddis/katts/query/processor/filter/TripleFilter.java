...
/**
 * A triple filter does build the variable bindings from a triple stream (output of 
 * an {@link Source} {@link Node}. 
 * 
...
public class TripleFilter extends AbstractNode implements ProducerNode, TripleFilterConfiguration{
	...
	public boolean validate() throws InvalidNodeConfigurationException {
		if (!groupOn.equals("subject") || !groupOn.equals("object") || !groupOn.equals("predicate")) {
			throw new InvalidNodeConfigurationException("The TripleFilterBolt can group the source stream only by 'subject', 'object' or 'predicate'");
		}
		return true;
	}
