...
public interface PartitionerConfiguration extends ProducerConfiguration, ConsumerConfiguration{
	...
	/**
	 * The {@link Variable} on which the partition (group) is build on. 
	 * This is like the "group by" in SQL languages. 
	 * 
	 * @return
	 */
	...
	/**
	 * The {@link Variable} on which the aggregation should be processed.
	 * This is like the field in the aggregation functions in SQL 
	 * languages.
	 * 
	 * @return
	 */
	...
	/**
	 * This method returns a list of components that builds
	 * aggregates on the defined partition.
	 * 
	 * @return
	 */
